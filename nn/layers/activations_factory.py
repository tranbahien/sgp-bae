...
from nn.layers import GELU, Swish, ConcatReLU, ConcatELU

act_strs = {'elu', 'leaky_relu', 'relu', 'gelu', 'swish', 'tanh'}
...
def act_module(act_str, allow_concat=False):
    ...
    elif act_str == 'leaky_relu': return nn.LeakyReLU()
    elif act_str == 'tanh': return nn.Tanh()
...
def act_factor(act_str, allow_concat=False):
    ...
    elif act_str == 'tanh': return 1 
    elif act_str == 'leaky_relu': return 1
